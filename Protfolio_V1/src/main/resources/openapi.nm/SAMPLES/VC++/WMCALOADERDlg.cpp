...
void CWMCALOADERDlg::OnConnect() 
{
	...
	m_wmca.Connect(GetSafeHwnd(),CA_WMCAEVENT,'T','W',strID,strPassword,strSignPassword);	//Namuh OpenAPI 사용자용
}
//━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
void CWMCALOADERDlg::OnButtonCurrent()	//현재가 조회
{
	...
	//m_wmca.Attach(GetSafeHwnd(),"o2","201N5315", 8, 8);	//2018년 05월물 콜옵션 행사가 315.0 현재가
	//m_wmca.Attach(GetSafeHwnd(),"o1","201N5315", 8, 8);	//2009년 05월물 콜옵션 행사가 315.0 호가
}
