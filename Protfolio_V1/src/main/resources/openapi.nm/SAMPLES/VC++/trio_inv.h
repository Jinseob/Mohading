...
typedef struct tagc4801OutBlock    //주식선물MASTER기본자료
{
	...
	char offerjan                         [  6];	char _offerjan;                           //매도잔량             
	char bidjan                           [  6];	char _bidjan;                             //매수잔량             
	char S2offer                          [  7];	char _S2offer;                            //매도2차호가          
	char S2bid                            [  7];	char _S2bid;                              //매수2차호가          
	char S2offerjan                       [  6];	char _S2offerjan;                         //매도2차잔량          
	char S2bidjan                         [  6];	char _S2bidjan;                           //매수2차잔량          
	char S3offer                          [  7];	char _S3offer;                            //매도3차호가          
	char S3bid                            [  7];	char _S3bid;                              //매수3차호가          
	char S3offerjan                       [  6];	char _S3offerjan;                         //매도3차잔량          
	char S3bidjan                         [  6];	char _S3bidjan;                           //매수3차잔량          
	char S4offer                          [  7];	char _S4offer;                            //매도4차호가          
	char S4bid                            [  7];	char _S4bid;                              //매수4차호가          
	char S4offerjan                       [  6];	char _S4offerjan;                         //매도4차잔량          
	char S4bidjan                         [  6];	char _S4bidjan;                           //매수4차잔량          
	char S5offer                          [  7];	char _S5offer;                            //매도5차호가          
	char S5bid                            [  7];	char _S5bid;                              //매수5차호가          
	char S5offerjan                       [  6];	char _S5offerjan;                         //매도5차잔량          
	char S5bidjan                         [  6];	char _S5bidjan;                           //매수5차잔량          
	char S6offer                          [  7];	char _S6offer;                            //매도6차호가          
	char S6bid                            [  7];	char _S6bid;                              //매수6차호가          
	char S6offerjan                       [  6];	char _S6offerjan;                         //매도6차잔량          
	char S6bidjan                         [  6];	char _S6bidjan;                           //매수6차잔량          
	char S7offer                          [  7];	char _S7offer;                            //매도7차호가          
	char S7bid                            [  7];	char _S7bid;                              //매수7차호가          
	char S7offerjan                       [  6];	char _S7offerjan;                         //매도7차잔량          
	char S7bidjan                         [  6];	char _S7bidjan;                           //매수7차잔량          
	char S8offer                          [  7];	char _S8offer;                            //매도8차호가          
	char S8bid                            [  7];	char _S8bid;                              //매수8차호가          
	char S8offerjan                       [  6];	char _S8offerjan;                         //매도8차잔량          
	char S8bidjan                         [  6];	char _S8bidjan;                           //매수8차잔량          
	char S9offer                          [  7];	char _S9offer;                            //매도9차호가          
	char S9bid                            [  7];	char _S9bid;                              //매수9차호가          
	char S9offerjan                       [  6];	char _S9offerjan;                         //매도9차잔량          
	char S9bidjan                         [  6];	char _S9bidjan;                           //매수9차잔량          
	char S0offer                          [  7];	char _S0offer;                            //매도10차호가         
	char S0bid                            [  7];	char _S0bid;                              //매수10차호가         
	char S0offerjan                       [  6];	char _S0offerjan;                         //매도10차잔량         
	char S0bidjan                         [  6];	char _S0bidjan;                           //매수10차잔량         
	...
	char tofferjan                        [  6];	char _tofferjan;                          //총매도잔량           
	char tobidjan                         [  6];	char _tobidjan;                           //총매수잔량           
...
typedef struct tagc4805OutHoga3    //주식선물호가3
{
	...
	char S2offerjan                       [  6];	char _S2offerjan;                         //2차매도잔량          
	char S2bidjan                         [  6];	char _S2bidjan;                           //2차매수잔량          
	char S3offer                          [  8];	char _S3offer;                            //3차매도호가          
	char S3bid                            [  8];	char _S3bid;                              //3차매수호가          
	char S3offerjan                       [  6];	char _S3offerjan;                         //3차매도잔량          
	char S3bidjan                         [  6];	char _S3bidjan;                           //3차매수잔량          
	char S4offer                          [  8];	char _S4offer;                            //4차매도호가          
	char S4bid                            [  8];	char _S4bid;                              //4차매수호가          
	char S4offerjan                       [  6];	char _S4offerjan;                         //4차매도잔량          
	char S4bidjan                         [  6];	char _S4bidjan;                           //4차매수잔량          
	char S5offer                          [  8];	char _S5offer;                            //5차매도호가          
	char S5bid                            [  8];	char _S5bid;                              //5차매수호가          
	char S5offerjan                       [  6];	char _S5offerjan;                         //5차매도잔량          
	char S5bidjan                         [  6];	char _S5bidjan;                           //5차매수잔량          
	char S6offer                          [  8];	char _S6offer;                            //6차매도호가          
	char S6bid                            [  8];	char _S6bid;                              //6차매수호가          
	char S6offerjan                       [  6];	char _S6offerjan;                         //6차매도잔량          
	char S6bidjan                         [  6];	char _S6bidjan;                           //6차매수잔량          
	char S7offer                          [  8];	char _S7offer;                            //7차매도호가          
	char S7bid                            [  8];	char _S7bid;                              //7차매수호가          
	char S7offerjan                       [  6];	char _S7offerjan;                         //7차매도잔량          
	char S7bidjan                         [  6];	char _S7bidjan;                           //7차매수잔량          
	char S8offer                          [  8];	char _S8offer;                            //8차매도호가          
	char S8bid                            [  8];	char _S8bid;                              //8차매수호가          
	char S8offerjan                       [  6];	char _S8offerjan;                         //8차매도잔량          
	char S8bidjan                         [  6];	char _S8bidjan;                           //8차매수잔량          
	char S9offer                          [  8];	char _S9offer;                            //9차매도호가          
	char S9bid                            [  8];	char _S9bid;                              //9차매수호가          
	char S9offerjan                       [  6];	char _S9offerjan;                         //9차매도잔량          
	char S9bidjan                         [  6];	char _S9bidjan;                           //9차매수잔량          
	char S0offer                          [  8];	char _S0offer;                            //10차매도호가         
	char S0bid                            [  8];	char _S0bid;                              //10차매수호가         
	char S0offerjan                       [  6];	char _S0offerjan;                         //10차매도잔량         
	char S0bidjan                         [  6];	char _S0bidjan;                           //10차매수잔량         
	char offersu                          [  4];	char _offersu;                            //매도건수             
	char bidsu                            [  4];	char _bidsu;                              //매수건수             
...
typedef struct tagvHOutBlock    //출력
{
	...
	char S2bid                            [  7];   //차매수호가           
	char S2offerjan                       [  6];   //차매도잔량           
	char S2bidjan                         [  6];   //차매수잔량           
	char S3offer                          [  7];   //차차매도호가         
	char S3bid                            [  7];   //차차매수호가         
	char S3offerjan                       [  6];   //차차매도잔량         
	char S3bidjan                         [  6];   //차차매수잔량         
	char S4offer                          [  7];   //4차매도호가          
	char S4bid                            [  7];   //4차매수호가          
	char S4offerjan                       [  6];   //4차매도잔량          
	char S4bidjan                         [  6];   //4차매수잔량          
	char S5offer                          [  7];   //5차매도호가          
	char S5bid                            [  7];   //5차매수호가          
	char S5offerjan                       [  6];   //5차매도잔량          
	char S5bidjan                         [  6];   //5차매수잔량          
	char S6offer                          [  7];   //6차매도호가          
	char S6bid                            [  7];   //6차매수호가          
	char S6offerjan                       [  6];   //6차매도잔량          
	char S6bidjan                         [  6];   //6차매수잔량          
	char S7offer                          [  7];   //7차매도호가          
	char S7bid                            [  7];   //7차매수호가          
	char S7offerjan                       [  6];   //7차매도잔량          
	char S7bidjan                         [  6];   //7차매수잔량          
	char S8offer                          [  7];   //8차매도호가          
	char S8bid                            [  7];   //8차매수호가          
	char S8offerjan                       [  6];   //8차매도잔량          
	char S8bidjan                         [  6];   //8차매수잔량          
	char S9offer                          [  7];   //9차매도호가          
	char S9bid                            [  7];   //9차매수호가          
	char S9offerjan                       [  6];   //9차매도잔량          
	char S9bidjan                         [  6];   //9차매수잔량          
	char S0offer                          [  7];   //10차매도호가         
	char S0bid                            [  7];   //10차매수호가         
	char S0offerjan                       [  6];   //10차매도잔량         
	char S0bidjan                         [  6];   //10차매수잔량         
	...
	char tofferjan                        [  6];   //총매도호가 잔량      
	char tobidjan                         [  6];   //총매수 호가 잔량     
...
typedef struct tagvCOutBlock    //출력
{
	...
	char S2offerjan                       [  6];	char _S2offerjan;                         //차매도잔량           
	char S2bidjan                         [  6];	char _S2bidjan;                           //차매수잔량           
	char S3offer                          [  7];	char _S3offer;                            //차차매도호가         
	char S3bid                            [  7];	char _S3bid;                              //차차매수호가         
	char S3offerjan                       [  6];	char _S3offerjan;                         //차차매도잔량         
	char S3bidjan                         [  6];	char _S3bidjan;                           //차차매수잔량         
	...
	char tofferjan                        [  6];	char _tofferjan;                          //총매도호가 잔량      
	char tobidjan                         [  6];	char _tobidjan;                           //총매수 호가 잔량     
